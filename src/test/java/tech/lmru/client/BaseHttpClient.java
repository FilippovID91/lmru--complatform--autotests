...
public class BaseHttpClient {
    ...
    public static String BASE_URI = environmentVariable("https://complatform-test-yc-customer-stage.apps.lmru.tech", "https://complatform-yc-customer-stage.apps.lmru.tech");
